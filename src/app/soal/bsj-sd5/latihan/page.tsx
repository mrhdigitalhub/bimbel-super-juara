  ...
  if(soal.length===0){
    return (
      <div className="max-w-2xl mx-auto p-5">
        <a href="/soal/bsj-sd5" className="text-[12px]">← Kembali ke Dashboard BSJ-SD5 - 30 BAB</a>
...
BAB: {bab}
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <a href="/soal/bsj-sd5" className="text-[12px] font-bold">← Kembali ke Dashboard BSJ-SD5 - 30 BAB</a>
      <div className="mt-4 border rounded-xl p-4 bg-white">
        <h1 className="font-black">BSJ-SD5 - {mapel} BAB {bab} - {soal.length} SOAL</h1>
