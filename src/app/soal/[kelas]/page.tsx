    ...
    <div style={{padding:24,maxWidth:800,margin:'0 auto'}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,marginTop:20}}>
        {[
          ...
          <a key={m} href={`/soal/${kelas}/latihan?mapel=${encodeURIComponent(m)}&bab=1`} style={{border:'1px solid #ddd',padding:20,borderRadius:16,textAlign:'center',fontWeight:'700',background:'#fff'}}>
            {m}<br/><small>BAB 1 - 30 Soal</small>
          </a>
        ))}
      </div>
